...
fun SufaraSettingsProvider(content: @Composable () -> Unit) {
    ...
    val settingsState = SufaraSettingsState(
        cyrillicFont, arabicFont, cyrillicSize, arabicSize, isDebugMode, 
    ...
    val actions = object : SufaraSettingsActions {
        ...
        override fun toggleDebugMode(enabled: Boolean) { isDebugMode = enabled; prefs.edit().putBoolean("debug_mode", enabled).apply() }
